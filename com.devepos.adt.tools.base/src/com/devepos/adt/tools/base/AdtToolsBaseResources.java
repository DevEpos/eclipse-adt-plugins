 ...
 * @author stockbal
 */
public class AdtToolsBaseResources {

	/**
	 * The JFace resource bundle; eagerly initialized.
	 */
	private static final ResourceBundle bundle = ResourceBundle.getBundle("com.devepos.adt.tools.base.messages"); //$NON-NLS-1$
	...
	public static ImageDescriptor getImageDescriptor(final String key) {
		return AdtToolsBasePlugin.getDefault().getImageDescriptor(key);
	}
	...
	public static ImageDescriptor getImageDescriptor(final String key, final boolean useGrayScale) {
		return AdtToolsBasePlugin.getDefault().getImageDescriptor(key, useGrayScale);
	}
	...
	public static Image getImage(final String key, final boolean useGrayScale) {
		return AdtToolsBasePlugin.getDefault().getImage(key, useGrayScale);
	}
	...
	public static Image getImage(final String key) {
		return AdtToolsBasePlugin.getDefault().getImage(key);
	}
