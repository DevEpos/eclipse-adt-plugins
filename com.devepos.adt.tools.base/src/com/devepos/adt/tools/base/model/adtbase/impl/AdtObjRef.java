...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Adt Obj Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getDescription <em>Description</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getName <em>Name</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getType <em>Type</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getUri <em>Uri</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getOwner <em>Owner</em>}</li>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.AdtObjRef#getTadirType <em>Tadir Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdtObjRef extends MinimalEObjectImpl.Container implements IAdtObjRef {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAdtBasePackage.ADT_OBJ_REF__DESCRIPTION, oldDescription, description));
	}
	...
	public void setPackageName(String newPackageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAdtBasePackage.ADT_OBJ_REF__PACKAGE_NAME, oldPackageName, packageName));
	}
	 ...
	 */
	@Override
	public void setTadirType(String newTadirType) {
		String oldTadirType = tadirType;
		tadirType = newTadirType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAdtBasePackage.ADT_OBJ_REF__TADIR_TYPE, oldTadirType, tadirType));
	}
