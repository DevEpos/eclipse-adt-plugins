 ...
 * </p>
 * <ul>
 *   <li>{@link com.devepos.adt.tools.base.model.adtbase.impl.User#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class User extends MinimalEObjectImpl.Container implements IUser {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAdtBasePackage.USER__NAME, oldName, name));
	}
