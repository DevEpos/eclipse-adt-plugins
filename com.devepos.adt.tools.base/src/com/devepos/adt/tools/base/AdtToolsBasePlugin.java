...
public class AdtToolsBasePlugin extends AbstractAdtUIPlugin {
	...
	protected void initializeImageRegistry(final ImageRegistry imageRegistry) {
		registerImage(imageRegistry, IGeneralWorkbenchImages.REFRESH, "icons/full/elcl16/refresh.png", "org.eclipse.search");
		registerImage(imageRegistry, IGeneralWorkbenchImages.IMPORT, "icons/full/etool16/import_wiz.png", "org.eclipse.ui");
		registerImage(imageRegistry, IGeneralWorkbenchImages.EXPORT, "icons/full/etool16/export_wiz.png", "org.eclipse.ui");
		registerImage(imageRegistry, IGeneralWorkbenchImages.EXPAND_ALL, "icons/full/elcl16/expandall.png", "org.eclipse.search");
