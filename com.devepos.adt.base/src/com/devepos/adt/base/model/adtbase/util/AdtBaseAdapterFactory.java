...
import com.devepos.adt.base.model.adtbase.*;
...
public class AdtBaseAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AdtBaseSwitch<Adapter> modelSwitch =
		new AdtBaseSwitch<Adapter>() {
			@Override
			public Adapter caseAdtObjRef(IAdtObjRef object) {
				return createAdtObjRefAdapter();
			}
			@Override
			public Adapter caseAdtObjRefList(IAdtObjRefList object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.devepos.adt.base.model.adtbase.IAdtObjRef <em>Adt Obj Ref</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.devepos.adt.base.model.adtbase.IAdtObjRefList <em>Adt Obj Ref List</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.devepos.adt.base.model.adtbase.IUser <em>User</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
