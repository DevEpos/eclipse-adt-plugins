...
public class Reflection {
    ...
    private static Method getPublicMethod(final Class<?> clazz, final String methodName, final Class<?>... argTypes) {
        try {
    ...
    private static Method getDeclaredMethod(final Class<?> clazz, final String name, final Class<?>... paramTypes) {
        try {
