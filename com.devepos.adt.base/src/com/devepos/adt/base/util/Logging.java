...
public class Logging implements ILogger {
    ...
    static {
        ...
        severityToLevel.put(2, Level.WARNING);
    ...
    public void error(final Throwable throwable, final String messageText, final Object... args) {
        delegate.log(toRecord(Level.SEVERE, throwable, messageText, args));
    }
     ...
     * @param throwable the exception like object
     * @param message   message string for the log entry
     * @param args      additional arguments for the message string
