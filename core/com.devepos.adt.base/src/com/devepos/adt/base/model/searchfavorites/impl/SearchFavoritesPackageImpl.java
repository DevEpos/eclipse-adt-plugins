 ...
 * @generated
 */
public class SearchFavoritesPackageImpl extends EPackageImpl implements ISearchFavoritesPackage {
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * @see com.devepos.adt.base.model.searchfavorites.ISearchFavoritesPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private SearchFavoritesPackageImpl() {
  ...
  public static ISearchFavoritesPackage init() {
    ...
    SearchFavoritesPackageImpl theSearchFavoritesPackage = registeredSearchFavoritesPackage instanceof SearchFavoritesPackageImpl
        ? (SearchFavoritesPackageImpl) registeredSearchFavoritesPackage
        : new SearchFavoritesPackageImpl();
