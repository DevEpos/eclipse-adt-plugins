 ...
 */
public class MultiViewerSelectionAdapter implements IPostSelectionProvider {
   ...
   */
  public MultiViewerSelectionAdapter() {
    this(null);
  }
   ...
   */
  public MultiViewerSelectionAdapter(final StructuredViewer viewerInFocus,
