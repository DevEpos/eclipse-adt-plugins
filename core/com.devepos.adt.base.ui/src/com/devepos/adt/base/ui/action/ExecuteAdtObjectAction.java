...
public class ExecuteAdtObjectAction extends Action {
  ...
  public ExecuteAdtObjectAction(final IProject project,
      final List<IAdtObjectReference> adtObjectReferences, final boolean isDataPreviewMode) {
    super();
  ...
  @Override
  public void run() {
    for (final IAdtObjectReference objRef : adtObjectReferences) {
      AdtObjectExecutor.executeObject(project, objRef);
    }
  }
