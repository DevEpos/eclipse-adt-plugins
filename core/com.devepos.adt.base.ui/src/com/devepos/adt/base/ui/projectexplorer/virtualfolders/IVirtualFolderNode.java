...
public interface IVirtualFolderNode {
  ...
  String FOLDER_KEY_BUSINESS_SERVICES = "rap_services";
   ...
   * 
   */
  List<String> getApiStateFilters();
  ...
  /**
   * Returns {@code true} if the node is the root node of a tree
   */
  boolean isTree();
