...
public class MenuItemFactory {
   ...
   *                   command
   */
  public static void addCommandItem(final IMenuManager mgr, final String groupId,
      final String commandId, final ImageDescriptor imageDescr, final String label,
      final String[][] params) {
    final IContributionItem commandItem = CommandFactory.createContribItem(commandId, imageDescr,
        label, true, params);
    if (groupId != null) {
