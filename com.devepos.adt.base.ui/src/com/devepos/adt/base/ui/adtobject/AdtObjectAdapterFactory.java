...
public class AdtObjectAdapterFactory implements IAdapterFactory {
  ...
  public <T> T getAdapter(final Object adaptableObject, final Class<T> adapterType) {
    ...
    if (adaptableObject instanceof ITextSelection) {
      ...
      final IProjectProvider projectProvider = Adapters.adapt(adaptableObject,
          IProjectProvider.class);
      return adapterType.cast(new AdtObject(objRef.getName(), objRef, objType,
          projectProvider != null ? projectProvider.getProject() : null));
