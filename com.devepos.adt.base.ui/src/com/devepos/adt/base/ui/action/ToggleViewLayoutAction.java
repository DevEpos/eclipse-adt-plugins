...
public class ToggleViewLayoutAction extends MenuManager implements IRadioActionToggleListener {
  ...
  public ToggleViewLayoutAction(final SashForm sashForm, final Control resizedControl,
      final IPreferenceStore prefStore, final String layoutPref, final boolean horizontal,
      final boolean vertical, final boolean automatic) {
    ...
    try {
      ...
      initialOrientation = automatic ? ViewLayoutOrientation.AUTOMATIC
