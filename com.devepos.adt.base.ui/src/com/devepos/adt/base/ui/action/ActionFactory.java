...
public class ActionFactory {
   ...
   */
  public static Action createAction(final String text, final ImageDescriptor imageDescriptor,
      final int style, final IActionRunner actionRunner) {
   ...
   * @return the created Action instance
   */
  public static <T> Action createActionWithData(final String text,
      final ImageDescriptor imageDescriptor, final IActionRunnerWithData<T> actionRunner,
      final T actionData) {
    Objects.requireNonNull(actionRunner, "Parameter 'actionRunner' must not be null");
