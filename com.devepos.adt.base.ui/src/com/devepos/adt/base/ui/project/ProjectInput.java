...
public class ProjectInput {
  ...
  public DataBindingContext createBindings(final DataBindingContext dbc) {
    ...
    final IConverter<String, IProject> convertStringToProject = IConverter.create(String.class,
        IProject.class, projectName -> {
    ...
    final UpdateValueStrategy<IProject, String> targetUpdateStrategy = UpdateValueStrategy.create(
        IConverter.create(IProject.class, String.class, project -> project != null ? project
            .getName() : ""));
