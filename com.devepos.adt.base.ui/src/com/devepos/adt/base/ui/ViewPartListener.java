...
public class ViewPartListener implements IPartListener2 {
	 ...
	 *                              {@link #partActivated(IWorkbenchPartReference)}
	 */
	public void setPartActivatedConsumer(final Consumer<IWorkbenchPartReference> partActivatedConsumer) {
	...
	public void partActivated(final IWorkbenchPartReference partRef) {
		if (this.partActivatedConsumer == null) {
			return;
		}
		this.partActivatedConsumer.accept(partRef);
	}

	@Override
	public void partVisible(final IWorkbenchPartReference partRef) {
		if (this.partVisibleConsumer == null) {
			return;
		}
		this.partVisibleConsumer.accept(partRef);
	}
