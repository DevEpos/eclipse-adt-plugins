...
import com.devepos.adt.tools.base.ui.adtobject.AdtObjectExecutor;
...
public class ExecuteAdtObjectAction extends Action {
	...
	public ExecuteAdtObjectAction(final IProject project, final List<IAdtObjectReference> adtObjectReferences,
		...
		if (isDataPreviewMode) {
			...
			setImageDescriptor(AdtToolsBaseUIResources.getImageDescriptor(IAdtToolsBaseImages.DATA_PREVIEW));
		} else {
			setText(Messages.Actions_ExecuteAdtObject_xmit);
			setImageDescriptor(AdtToolsBaseUIResources.getImageDescriptor(IAdtToolsBaseImages.RUN_OBJECT));
		}
