...
import com.devepos.adt.tools.base.ui.userinfo.IUserService;
...
public class UserService implements IUserService {
	...
	public List<String> showUserSelectionDialog(final Shell parent, final String title, final boolean multi,
		...
		final UserNameSelectionDialog userDialog = new UserNameSelectionDialog(parent, title, multi, initialUsers, destinationId);
