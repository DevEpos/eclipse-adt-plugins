 ...
 * @author stockbal
 */
public class AdtToolsBaseUIResources {

	/**
	 * The JFace resource bundle; eagerly initialized.
	 */
	private static final ResourceBundle bundle = ResourceBundle.getBundle("com.devepos.adt.tools.base.ui.messages"); //$NON-NLS-1$
	...
	public static ImageDescriptor getImageDescriptor(final String key) {
		return AdtToolsBaseUIPlugin.getDefault().getImageDescriptor(key);
	}
	...
	public static ImageDescriptor getImageDescriptor(final String key, final boolean useGrayScale) {
		return AdtToolsBaseUIPlugin.getDefault().getImageDescriptor(key, useGrayScale);
	}
	...
	public static Image getImage(final String key, final boolean useGrayScale) {
		return AdtToolsBaseUIPlugin.getDefault().getImage(key, useGrayScale);
	}
	...
	public static Image getImage(final String key) {
		return AdtToolsBaseUIPlugin.getDefault().getImage(key);
	}
