package com.devepos.adt.tools.base.ui.viewers;
...
public class LabelViewer extends ContentViewer {
	...
	public LabelViewer(final Composite parent, final int style) {
		...
		GridDataFactory.swtDefaults().align(SWT.FILL, SWT.CENTER).grab(true, false).applyTo(this.viewForm);
		this.label = new CLabel(this.viewForm, SWT.FLAT);
		this.label.setFont(parent.getFont());
		this.viewForm.setContent(this.label);
		hookControl(this.viewForm);
