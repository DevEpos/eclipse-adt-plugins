...
public class ViewMenuCreator {
	...
	private static class ViewMenu implements IDisposable {
		...
		public void createViewMenu(final Composite parent, final Consumer<IMenuManager> menuFiller) {
			...
			this.toolItem.setImage(AdtToolsBaseUIResources.getImage(IAdtToolsBaseImages.VIEW_MENU));
			this.toolItem.setToolTipText(AdtToolsBaseUIResources.getString(IAdtToolsBaseStrings.Menu));
