 ...
 * </p>
 * <ul>
 * <li>{@link com.devepos.adt.atm.model.abaptags.impl.AbapTagsContent#getTags <em>Tags</em>}</li>
 * <li>{@link com.devepos.adt.atm.model.abaptags.impl.AbapTagsContent#getTaggedObjectInfos
 * <em>Tagged Object Infos</em>}</li>
 * <li>{@link com.devepos.adt.atm.model.abaptags.impl.AbapTagsContent#getSharedTags <em>Shared
 * Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbapTagsContent extends MinimalEObjectImpl.Container implements IAbapTagsContent {
  /**
  ...
  protected EClass eStaticClass() {
    return IAbapTagsPackage.Literals.ABAP_TAGS_CONTENT;
  }
  ...
  public EList<ITag> getTags() {
    if (tags == null) {
      tags = new EObjectContainmentEList<>(ITag.class, this,
          IAbapTagsPackage.ABAP_TAGS_CONTENT__TAGS);
    }
    return tags;
  }
  ...
  public EList<ITag> getSharedTags() {
    if (sharedTags == null) {
      sharedTags = new EObjectContainmentEList<>(ITag.class, this,
          IAbapTagsPackage.ABAP_TAGS_CONTENT__SHARED_TAGS);
    }
    return sharedTags;
  }
  ...
  public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
    ...
    switch (featureID) {
    case IAbapTagsPackage.ABAP_TAGS_CONTENT__TAGS:
      return ((InternalEList<?>) getTags()).basicRemove(otherEnd, msgs);
    case IAbapTagsPackage.ABAP_TAGS_CONTENT__TAGGED_OBJECT_INFOS:
      return ((InternalEList<?>) getTaggedObjectInfos()).basicRemove(otherEnd, msgs);
    case IAbapTagsPackage.ABAP_TAGS_CONTENT__SHARED_TAGS:
