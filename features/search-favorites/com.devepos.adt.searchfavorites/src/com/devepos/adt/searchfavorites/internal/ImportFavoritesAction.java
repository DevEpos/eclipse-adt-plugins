...
public class ImportFavoritesAction extends Action {
  ...
  public ImportFavoritesAction() {
    super(Messages.FavoritesImporter_ImportFavoritesAction_xmit, AdtBaseUIResources
  ...
  public void run() {
    ...
    var importer = new FavoritesImporter(importedFavs -> {
      ...
      var insertNewFavsAtBeginning = makeNewFavsVisible && prefStore.getBoolean(
          IPreferences.INSERT_NEW_FAVS_AT_START);
    ...
    }, favToBeImported -> existingFavorites.contains(favToBeImported.getDestinationId(), favToBeImported
        .getSearchType(), favToBeImported.getDescription()));
