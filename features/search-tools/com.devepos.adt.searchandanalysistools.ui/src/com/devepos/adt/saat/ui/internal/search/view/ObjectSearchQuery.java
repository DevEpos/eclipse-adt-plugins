...
import com.devepos.adt.saat.ui.internal.search.ObjectSearchContentHandler;
...
public class ObjectSearchQuery implements ISearchQuery {
  ...
  public IStatus run(final IProgressMonitor monitor) throws OperationCanceledException {
    ...
    try {
      final com.devepos.adt.saat.ui.internal.search.ObjectSearchResult searchResult = restResource.get(
          monitor, AdtUtil.getHeaders(),
          com.devepos.adt.saat.ui.internal.search.ObjectSearchResult.class);
