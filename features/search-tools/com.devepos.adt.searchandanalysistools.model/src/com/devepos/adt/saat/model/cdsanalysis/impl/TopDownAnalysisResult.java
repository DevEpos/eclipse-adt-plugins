 ...
 * @generated
 */
public class TopDownAnalysisResult extends MinimalEObjectImpl.Container
    implements ITopDownAnalysisResult {
  /**
    ...
    if (newSourceEntity != sourceEntity) {
      ...
      if (sourceEntity != null) {
        msgs = ((InternalEObject) sourceEntity).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - ICdsAnalysisPackage.TOP_DOWN_ANALYSIS_RESULT__SOURCE_ENTITY,
            null, msgs);
      }
